...
#print(r_df)
    ...
    s="Number of nouns is(are) :"+str(nc) + "\nNumber of adjective is(are) :"+str(adjc)+"\nNumber of verb is(are) :"+str(vc)+"\nNumber of adverb is(are) :"+str(advc)+"\nNumber of Misspelled words is(are) :"+str(count_spell_error(essay))
    print("Number of nouns is(are)",nc)
    print("Number of adjective is(are)",adjc)
    print("Number of verb is(are)",vc)
    print("Number of adverb is(are)",advc)
    print("Number of Misspelled words is(are) ",count_spell_error(essay))
    return s
